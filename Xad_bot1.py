...
menu_keyboard = [[ telegram.KeyboardButton('/d4'),telegram.KeyboardButton('/d6'),
	telegram.KeyboardButton('/d8'),telegram.KeyboardButton('/d10')],[telegram.KeyboardButton('/d12'),
	telegram.KeyboardButton('/d20'),telegram.KeyboardButton('/d100')],[telegram.KeyboardButton('/start'),
	telegram.KeyboardButton('/bell'),telegram.KeyboardButton('/foto')]]
...
updater = Updater(token='166813950:AAEwgLAofYspsbBWH7ULKdAyz6E_vXbBESI')
dispatcher = updater.dispatcher


dispatcher.addHandler(MessageHandler([Filters.text, Filters.voice, Filters.audio, Filters.video], gestione_messaggi))
dispatcher.addHandler(CommandHandler("start",comando_start))
dispatcher.addHandler(CommandHandler("d4",dado_4, pass_args=True))
dispatcher.addHandler(CommandHandler("d6",dado_6))
dispatcher.addHandler(CommandHandler("d8",dado_8))
dispatcher.addHandler(CommandHandler("d10",dado_10))
dispatcher.addHandler(CommandHandler("d12",dado_12))
dispatcher.addHandler(CommandHandler("d20",dado_20))
dispatcher.addHandler(CommandHandler("d100",dado_100))
dispatcher.addHandler(CommandHandler("bell",bell))
dispatcher.addHandler(CommandHandler("foto", send_foto))
dispatcher.addHandler(RegexHandler(r'/.*',sconosciuto))
